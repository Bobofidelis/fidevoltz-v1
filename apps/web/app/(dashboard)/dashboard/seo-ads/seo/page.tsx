...
import {
  ...
  Tag, Link as LinkIcon, FileText, Layers, ArrowLeft
} from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 px-6 pt-8 pb-16">
        <div className="max-w-6xl mx-auto">
          {/* Back nav */}
          <Link href="/dashboard/seo-ads" className="inline-flex items-center gap-1.5 text-blue-200 hover:text-white text-sm mb-4 transition-colors">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <Button
                ...
                onClick={() => (refreshAnalytics as any)?.()}
              >
      ...
      {/* ── KPI strip overlapping gradient ── */}
              ...
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {[
                    ...
                    { href: "/dashboard/seo-ads", icon: BarChart3, label: "SEO & Ads Hub", desc: "Main overview", color: "hover:border-purple-400 hover:bg-purple-50" },
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Full ad management on the dedicated manager page</CardDescription>
                  </div>
                  <Link href="/dashboard/seo-ads/ads">
